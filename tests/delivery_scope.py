...
DELIVERY_TEST_MODULES: tuple[str, ...] = (
    ...
    "test_m10_public_api",
    "test_m10_release_gate",
    "test_m10_runtime_qualification",
    "test_mutation_posture",
    "test_observability",
...
DELIVERY_THEMES: dict[str, str] = {
    ...
    "stable_public_api": "test_m10_public_api",
    "stable_release_evidence": "test_m10_release_gate",
    "stable_runtime_qualification": "test_m10_runtime_qualification",
    "stable_readonly_mutation_gate": "test_mutation_posture",
