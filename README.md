...
[![Package: rexecop 0.2.9a0](https://img.shields.io/badge/package-rexecop%200.2.9a0-blueviolet.svg)](https://pypi.org/project/rexecop/0.2.9a0/)
...
```bash
pip install "rexecop[tecrax]==0.2.9a0"
