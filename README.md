...
[![Package: rexecop 0.1.4a1](https://img.shields.io/badge/package-rexecop%200.1.4a1-blueviolet.svg)](pyproject.toml)
...
| Tests | 139+ pytest tests (CI: ruff, mypy, public truth, boundary grep, secret scan, pytest) |
