...
[![Package: rexecop 0.2.6a0](https://img.shields.io/badge/package-rexecop%200.2.6a0-blueviolet.svg)](https://pypi.org/project/rexecop/0.2.6a0/)
...
The published `0.2.6a0` wheel contains the full B2 enforcement path and R4c
...
```bash
pip install "rexecop[tecrax]==0.2.6a0"
