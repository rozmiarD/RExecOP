...
RExecOp `0.2.7a0` is a published alpha line for operator evaluation. This document states
...
| Limitation | Detail |
| --- | --- |
| Public PyPI | `rexecop==0.2.7a0` published for alpha evaluation — not a production-ready claim |
