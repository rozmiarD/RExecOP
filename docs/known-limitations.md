...
RExecOp `0.2.4a0` is an **alpha** release for operator evaluation. This document states
...
| Limitation | Detail |
| --- | --- |
| Public PyPI | `rexecop==0.2.4a0` published for alpha evaluation — not a production-ready claim |
| Alpha semver line | `0.2.4a0` is the current alpha line; see [CHANGELOG.md](../CHANGELOG.md) for history |
