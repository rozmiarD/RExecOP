...
| Governed admission is source-qualified, not public-baseline capability | GovEngine `typed_execution_governed_admission` v0.1/v0.2 consumption is qualified against immutable source commit `9a78650a0e39524dcbf07d98f5fb71f89093fc66`. Public `govengine==1.0.0rc1` remains sufficient for ordinary read-only use but may lack optional v0.2; configured plugin mutation fails closed. |
