...
| Field | Value |
|-------|-------|
| RExecOp version (dev line) | `0.2.9a0` |
| RExecOp version (PyPI published) | `0.2.9a0` |
| GovEngine version | `0.16.1` |
| Tecrax version | `0.3.7a0` |
...
| PyPI stack install smoke | [x] | `govengine==0.16.2` `rexecop==0.2.9a0` `tecrax==0.3.7a0`; `pip check` clean |
...
| 5 | No secrets in runtime root exports (`rg` clean) | [x] | `rg` on evidence tree — no hits |
...
| SCLite bundle | `<root>/sclite/op-20260621-075639-63aaee/` |
...
- Etap A contract hardening + execution receipt boundary + PolicyEngine E2E in `0.2.9a0`.
