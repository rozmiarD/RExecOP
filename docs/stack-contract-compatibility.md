...
This matrix records the source contract baseline that RExecOp `0.2.24a0`
...
| --- | --- | --- | --- |
| `sclite-core` | `1.0.9` | `sclite-core==1.0.9` | SCLite truth, reaction, trigger-decision, watchdog-decision and automation-chain artifact schemas. |
| `govengine` | `0.16.11` | `govengine==0.16.11` | PolicyEngine MVP, B2 enforcement-plan contracts, trigger-planning admission, supervisor-action admission, supervisor explanations and automation-transition admission. |
| `rexecop` | `0.2.24a0` | current package | Neutral runner, connectors, catalog and reaction mechanics. |
| `tecrax` | `0.3.11a0` | `tecrax==0.3.21a0` via optional extra | Domain infrastructure profile. |
